...
/// <summary>
/// Insurance plan associated with a patient.
/// </summary>
public sealed class InsuranceInfo
{
    ...
    /// <summary>
    /// Abbreviation or short code for the insurer.
    /// </summary>
    ...
    /// <summary>
    /// Patient's relationship to the policy holder (Self, Spouse, Child, Other).
    /// </summary>
    public string? Relation { get; init; }

    /// <summary>
    /// Employer through which the plan is provided.
    /// </summary>
