...
/// <summary>
/// Terminal UI for collecting (or confirming) a MySQL connection profile.
/// Uses Spectre.Console prompts so the password is masked and defaults are
/// pre-filled from the last saved profile.
/// </summary>
public static class ConnectionSetup
{
    /// <summary>
    /// Shows a connection setup screen.
    /// If <paramref name="saved"/> is provided the user is offered to reuse it;
    /// otherwise every field must be entered.
    /// </summary>
